...
<form action="/himpunan/update/{{$himpunan->id_variabel_himpunan}}" method="POST" enctype="multipart/form-data">
@csrf
	<div class="content">
			<div class="row">
				<div class="col-sm-6"> 		
					...
					<div class="form-group">
						...
						@error('id_variabel')
							{{ $message }}
						@enderror
						<select id="inputVariabel" class="form-control" name="id_variabel" class="form-control" value="{{ $himpunan->id_variabel}}">
									<option>{{ old('id_variabel')}}</option>
